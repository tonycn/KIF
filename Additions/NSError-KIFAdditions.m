...
+ (instancetype)KIFErrorWithFormat:(NSString *)format, ...
{
    ...
    return [self errorWithDomain:@"KIFTest" code:1001 userInfo:@{NSLocalizedDescriptionKey: description}];
}
...
+ (instancetype)KIFErrorWithUnderlyingError:(NSError *)underlyingError format:(NSString *)format, ...
{
    ...
    return [self errorWithDomain:@"KIFTest" code:1001 userInfo:userInfo];
}
